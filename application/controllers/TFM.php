		...
		public function partant()
		 ...
		 public function partantF()
            ...
            $this->load->library('pagination');
			 	...
			 	$data['count1'] = $this->Tfm_part_model->TFMPartConfirmedBySexeHListing() + ($this->Tfm_part_model->TFMPartConfirmedBySexeFListing() ;
				$data['count2'] = $this->Tfm_part_model->TFMPartConfirmedBySexeHListing() + ($this->Tfm_part_model->TFMPartConfirmedBySexeFListing() ;
		                $searchText='' ;
		                $data['userId'] = $this->vendorId ;
