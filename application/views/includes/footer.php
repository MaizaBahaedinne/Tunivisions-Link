...
<!-- end:: Page -->
    	...
    	<!--begin::Global Theme Bundle(used by all pages) -->
		    	   ...
		    	   <script src="<?php echo base_url() ?>assets/js/demo12/scripts.bundle.js" type="text/javascript"></script>
            ...
            <!--begin::Page Scripts(used by this page) -->
                            <script src="<?php echo base_url() ?>assets/js/demo12/pages/dashboard.js" type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->

<!-- Mirrored from keenthemes.com/metronic/preview/demo12/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Aug 2019 19:49:08 GMT -->
</html>