                                ...
                                <div class="kt-section__body">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control" disabled  type="email" value="<?php echo $userInfo->cin ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $mobile ?>" placeholder="Phone" aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $email ?>" placeholder="Email" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
