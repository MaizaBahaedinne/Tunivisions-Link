                                ...
                                <div class="cover">
                                    ...
                                    <div class="cover-body d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <span class="profile-name">Club Tunivisions <?php echo $clubInfo->name ?> <br> <br></span>
                                            <br>
                                        </div>
                                ...
                                <div class="header-links">
                                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                                        ...
                                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center active">
                                            ...
                                            <a class="pt-1px d-none d-md-block" href="#">Membres <span class="text-muted tx-12"><?php echo $membersCount ?></span></a>
                                        </li>
                                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        <div class="row">
                                            ...
                                            <div class="profile-name"><?php echo $b->Tname ?> <br><small><?php echo $b->role ?> <?php echo $b->cellule ?> </small></div>
