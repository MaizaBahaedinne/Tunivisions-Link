...
class Tfm_part_model extends CI_Model
{
    ...
    {
        $this->db->select(' BaseTbl.id , Users.name , Clubs.name ClubName , Role.role , Users.cellule , Users.gouvernorat , BaseTbl.p_tranch1 , BaseTbl.p_tranch2 , BaseTbl.moto , BaseTbl.sysMobile , BaseTbl.statut , Usersr2.name as recp2 , BaseTbl.dateP_tranch2 as dateTranche2 ');
        ...
        $this->db->where('BaseTbl.tfmId = 6 and (BaseTbl.statut = 3 or BaseTbl.statut = 1 )  ' );
